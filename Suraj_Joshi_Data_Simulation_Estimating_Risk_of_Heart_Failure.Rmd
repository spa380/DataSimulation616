...
Finally, when we fit all the features against risk score, we find that all the features are significant.  More tunning can be done to achieve optimal data.
...
-Even with method different from the point system, satisfactory level of data can be simulated.